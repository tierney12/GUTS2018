    ...
    * 3rd byte onwards is the payload encoded in JSON
    ...
    def readMessage(self):
        ...
        if messageLen == 0:
            ...
            messagePayload['MessageType'] = self.MessageTypes.toString(messageType)

        logging.debug('Turned message {} into type {} payload {}'.format(binascii.hexlify(messageData),
    ...
    def sendMessage(self, messageType=None, messagePayload=None):
        ...
        logging.debug(
            'Turned message type {} payload {} into {}'.format(self.MessageTypes.toString(messageType), messagePayload,
